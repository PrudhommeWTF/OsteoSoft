...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    noneResultsText: 'Aucun résultat {0}',
    addNewText: '<strong>Ajouter :</strong> {0}',
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? "{0} éléments sélectionnés" : "{0} éléments sélectionnés";
    },
          ...
          if (!that.$lis.not('.hidden, .no-results').length) {
            ...
            if (that.options.addResults) {
              ...
              $no_results.on('click', function() {
                //var val = htmlEscape(that.$searchbox.val()); // MODIF MC
                var val = (that.$searchbox.val());
